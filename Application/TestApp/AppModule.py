...
def run(conf_path=None):
    ...
    app1.set_resdir("/afs/ihep.ac.cn/users/z/zhaobq/workerSpace/DistJET_v2/test/TestApp_res")
    ...
    app2.set_resdir("/afs/ihep.ac.cn/users/z/zhaobq/workerSpace/DistJET_v2/test/TestApp2_res")
