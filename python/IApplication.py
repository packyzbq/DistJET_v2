...
class IApplication:
    ...
    def set_init_extra(self, init_extra):
        ...
        if not type(init_extra) is types.DictionaryType:
            return
        self.app_init_extra=dict(self.app_init_extra.items()+init_extra.items())
    ...
    def set_fin_extra(self, fin_extra):
        ...
        if not type(fin_extra) is types.DictionaryType:
            return
        self.app_fin_extra=dict(self.app_fin_extra.items()+fin_extra.items())
